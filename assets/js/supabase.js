...
// Avoid redeclaring the global `supabase` identifier provided by the CDN.
const sb = window.sb || (window.supabase && window.supabase.createClient(SUPABASE_URL, SUPABASE_ANON_KEY));
